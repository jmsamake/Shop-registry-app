{
    ...
    'data': [
        ...
        'views/registry_app_registry_app_table_view_website.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'registry_app/static/src/webclient/**/*',
            ...
            'registry_app/static/src/js/new.js',
        ...
        'web.assets_qweb': [
            ...
            'registry_app/static/src/webclient/navbar/registry_app_navbar.xml',
